...
fil = activeFilament(dim = 3, Np = 32, b0 = 2, k = 10, radius = 1, S0 = 0, D0 = 1.5, bc = bc)
...
fil.simulate(Tf, Npts, activity_profile = activity_Function, save = True, overwrite = False, path = root_path ,
			activity_timescale = activity_timescale, sim_type = 'point', init_condition = {'shape':'sinusoid','plane':'xy'})
